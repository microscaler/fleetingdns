use sea_orm_migration::{
    prelude::*,
    schema::{big_integer, boolean, float, integer, string, timestamp},
};
...
impl MigrationTrait for Migration {
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(string(ServicePlan::Id).primary_key())
        ...
        manager
            .create_table(
                Table::create()
                    .table(Pricing::Table)
                    .if_not_exists()
                    .col(string(Pricing::Id).primary_key())
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(string(UserServicePlan::Id).primary_key())
        ...
        manager
            .create_table(
                Table::create()
                    .table(Tunnel::Table)
                    .if_not_exists()
                    .col(string(Tunnel::Id).primary_key())
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(string(SshKeyPair::Id).primary_key())
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(string(CertificateInfo::Serial).primary_key())
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(string(ApiStats::Id).primary_key())
        ...
        manager
            .create_table(
                Table::create()
                    .table(CaStats::Table)
                    .if_not_exists()
                    .col(string(CaStats::Id).primary_key())
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(string(PaymentInfo::Id).primary_key())
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(string(UserUsage::Id).primary_key())
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .if_not_exists()
                    .col(string(BillingEvent::Id).primary_key())
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            .drop_table(Table::drop().table(BillingEvent::Table).to_owned())
            .await?;
        manager
        ...
        manager
            ...
            .await?;
        manager
            .drop_table(Table::drop().table(PaymentInfo::Table).to_owned())
            .await?;
        manager
            .drop_table(Table::drop().table(CaStats::Table).to_owned())
            .await?;
        manager
            .drop_table(Table::drop().table(ApiStats::Table).to_owned())
            .await?;
        manager
            .drop_table(Table::drop().table(CertificateInfo::Table).to_owned())
            .await?;
        manager
            .drop_table(Table::drop().table(AuthToken::Table).to_owned())
            .await?;
        manager
            .drop_table(Table::drop().table(SshKeyPair::Table).to_owned())
            .await?;
        manager
            .drop_table(Table::drop().table(Tunnel::Table).to_owned())
            .await?;
        manager
            .drop_table(Table::drop().table(UserServicePlan::Table).to_owned())
            .await?;
        manager
            .drop_table(Table::drop().table(Pricing::Table).to_owned())
            .await?;
        manager
            .drop_table(Table::drop().table(ServicePlan::Table).to_owned())
            .await?;
        manager
