...
| **T-21** | Wire dnsd ↔ EdgeHub end-to-end demo (docs + Docker compose setup and script to test in ci job or demo). | `docker/docker-compose.yml`, `scripts/roundtrip_demo.sh`, `.github/workflows/compose-ci.yml`, `docker/README.md` | Demo for peer review |
