...
| - [ ] **T-30** | Compose update: add edgehub + Redis env vars | `docker/docker-compose.yml` | Include edgehub container on port 2222, link to Redis, mount dev certs, and expose 853 for dnsd. |
